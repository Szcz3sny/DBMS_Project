        ...
        <div className="mt-8">
          ...
          <p>
            <span className="bg-black bg-opacity-80 px-2 py-1 rounded-md">
              ...
              <br />
              <br />
              Trzeba chwile poczekać na api od Google-maps
            </span>
          </p>
        </div>

        {/* Dodaj odstęp po lokalizacji */}
        <div className="mt-8"></div>

        <div className="relative overflow-hidden" style={{ paddingBottom: "40%" }}>
          <iframe
            title="Mapa Google"
            className="absolute top-0 left-1/2 w-1/2 -translate-x-1/2 h-full"
